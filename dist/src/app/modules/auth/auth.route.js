...
import { loginZodSchema, changePasswordZodSchema, setPasswordZodSchema, forgotPasswordZodSchema, resetPasswordZodSchema, } from "./auth.validation";
...
router.post("/reset-password", checkAuth(...Object.values(Role)), validateRequest(resetPasswordZodSchema), AuthController.resetPassword);

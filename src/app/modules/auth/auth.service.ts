...
const changePassword = async (oldPassword: string, newPassword: string, decodedToken: IJWTPayload) => {
...
const resetPassword = async (payload: Record<string, any>, decodedToken: IJWTPayload) => {
...
const setPassword = async (userId: string, plainPassword: string) => {
    ...
    if (user.password && user.authProviders.some(providerObject => providerObject.provider === AuthProviderType.GOOGLE)) {
